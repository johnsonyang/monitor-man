<template>
  <div style="margin-bottom: 50px;">
    <h3 style="background-color: #f8f8f8;line-height: 3.5;text-align: center;"><span style="color: red;">编辑用例集合 {{name}}</span></h3>
    <p>请查看 <a href="https://github.com/postmanlabs/newman#newmanrunoptions-object--callback-function--run-eventemitter">nnewman.run选项</a>
      获取更多配置信息
    </p>
    <form v-on:submit.prevent="submit">
      ...
      <button type="submit" class="btn btn-primary mm-click">编辑</button>
    </form>
  </div>
</template>
